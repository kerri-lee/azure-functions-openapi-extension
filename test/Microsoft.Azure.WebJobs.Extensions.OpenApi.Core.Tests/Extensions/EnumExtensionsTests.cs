...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Extensions
{
    ...
    public class EnumExtensionsTests
    {
        ...
        [DataRow(FakeStringEnumWithSystemJson.StringValue1, "lorem")]
        [DataRow(FakeStringEnumWithSystemJson.StringValue2, "ipsum")]
        [DataRow(FakeStringEnumWithSystemJson.StringValue3, "dolor")]
        [DataRow(FakeStringEnumWithSystemJson.StringValue4, "StringValue4")]
